			...
			<div class="table-responsive col-sm-10">
				...
				<thead>
					...
					<c:forEach var="o" items="${orderList}">
						...
						<td>${o.orderDate}</td>
						<%
							com.hupeng.model.Order o=(com.hupeng.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							System.out.println(userId);
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("connection");
							com.hupeng.dao.UserDao userDao=new com.hupeng.dao.UserDao();
						...
						<%
							...
							String paymentType=com.hupeng.model.Payment.findByPaymentId(con,n);
							 %>
